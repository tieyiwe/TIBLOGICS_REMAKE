...
export function SceneArfa() {
  return (
    ...
    >
      <motion.img 
        src="/arfa-banner.png" 
        className="w-[60cqw] rounded-2xl shadow-2xl z-10"
      ...
      <motion.h2 
        className="text-[6cqw] font-syne font-bold absolute bottom-[-5%] text-white/20 whitespace-nowrap z-0 pointer-events-none"
        animate={{ x: ['100%', '-100%'] }}
