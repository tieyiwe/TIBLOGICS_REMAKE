...
const SERVICES = [
  ...
  { id: "tech", name: "Other Consulting (Apps, SaaS, Special Features…)", duration: "1h", price: 24900, badge: null, description: "Expert guidance on app development, SaaS products, special features, or any technical challenge.", color: "#3A4A5C" },
];
